  ...
  return (
    <div className="container has-text-centered">
      <div className="content is-size-7">
        ...
        <a href="https://www.swinburne.edu.au/" target="_blank" class="has-text-dark has-text-weight-bold">
          Swinburne University of Technology</a>
          in partnership with <a href="https://arq.group" target="_blank" class="has-text-dark has-text-weight-bold">Arq Group</a>,

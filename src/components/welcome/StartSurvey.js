  ...
  return (
    <div className="start-button has-text-centered">
      <p className="has-text-weight-bold is-size-6">
        By using the Symptom Tracker, you are indicating that you agree that your answers
        can be used in <a aria-label="What happens to my answers?" onClick={handleShowSection}>this way</a>
      </p>
      {
        props.disableStart

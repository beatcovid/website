    ...
    <section className="share-section card is-info">
      ...
      <div className="card-content">
        ...
        <div className="social-sharing">
          <a
            href="http://www.facebook.com/sharer.php?u=BeatCovid19now.org"
            target="_new"
          >
        ...
        <div className="social-sharing">
          ...
          <a
            target="_new"
            href="mailto:?subject=BeatCOVID19Now&body=BeatCovid19Now by completeing their tracker. Together we are mapping the spread and symptoms of Covid19, leading to better outcomes for all of us. Help too at https://beatcovid19now.org"
          >
